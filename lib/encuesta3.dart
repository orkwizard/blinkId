...
import 'encuesta4.dart';

class EncuestaPage3 extends StatefulWidget {
  @override
  _EncuestaPage3State createState() => _EncuestaPage3State();
}

class _EncuestaPage3State extends State<EncuestaPage3> {
  late double w, h;
  int valGroup = 0;
  ...
  _opciones() {
    return Column(
      children: [
        _opcion(1, "Lo apruebo mucho"),
        _opcion(2, "Lo apruebo"),
        _opcion(3, "Lo desapruebo"),
  ...
  _textoSig() {
    return Container(
      ...
      alignment: Alignment.center,
      child: Text(
        "¿Qué tanto aprueba o desapruebael trabajo de la administración en turno?",
